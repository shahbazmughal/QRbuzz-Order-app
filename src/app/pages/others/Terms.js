    ...
    return (
        <div class="osahan-faq">
            <div class="bg-primary border-bottom px-3 pt-3 pb-5">
                ...
                <h2 class="font-weight-bold m-0 text-white pt-3">Terms &amp; conditions</h2>
                <p class="mb-2 text-white-50 small">Effective date: 1 January 2020
                </p>
            </div>
            <div class="bg-light mb-4 p-3 osahan-faq-item">
                <div class="osahan-privacy bg-white rounded shadow p-4 mt-n5">
                <div id="intro" class="mb-4">
                    <div class="mb-3">
                        <h2 class="h5">Welcome to Swiggi</h2>
                    </div>
